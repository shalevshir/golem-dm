...
- Decisions live in `docs/decisions/` as ADRs. 0001 (2024/SRD 5.2.1), 0002 (solo), 0003 (spatial) are ACCEPTED; 0004 (campaign vs. session identity) is PROPOSED — check status before assuming anything is still open.
